...
<body>
  <div class="container">
    <div class="row justify-content-center">
      ...
      <?php if (isset($error)) : ?>
        <p style="font-size: 18px; font-style: italic; color: red;"><?= $error; ?></p>
      <?php endif; ?>
      <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          ...
          <input type="file" id="gambar" name="gambar" class="form-control gambar" onchange="previewImage()">
          <img src="img/nophoto.png" alt="" width="200px" class="img-preview">
        </div>
